...
- Fixed-server 168h `city_337` Base sequence `/data/zz2/National_model/outputs/planning_sequence_168h_v0722_city337` and immediate `--resume` pass. Solver runtimes are 733.00/811.58/892.10/1397.12 s; wall time 1:13:47; peak RSS 4,085,152 KiB; zero swaps. Every year is `OPTIMAL + solution_qc=PASS`, has zero false hard checks, 337 center rows, 642 intra-edge rows, 31 province-account rows and 59 manifest entries. Maximum center/province/intra-capacity/power residuals are `7.09e-11 GWh`, `2.73e-12 GWh`, `8.24e-12 GWh` and `1.78e-10 GW`; BECCS net-carbon residual is numerical zero. Compared with the prior 278 Base gate, the 337 layer adds only 1,031 variables, 924 constraints and 2,749 nonzeros at 168h; total solver time increases 4.68%, dominated by a 706.6 s 2060 Crossover. A separate 24h `flexible_load_v1` city_337 chain is now active under PID `3632117`; keep the server checkout unchanged while it runs.
