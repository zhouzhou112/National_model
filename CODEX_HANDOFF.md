...
- Fixed-server 24h `city_337` Base sequence `/data/zz2/National_model/outputs/planning_sequence_24h_v0722_city337` passes four years and `--resume`. Solver runtimes are 43.29/48.82/41.17/46.90 s; wall time 7:21; peak RSS 930,204 KiB. Every year is `OPTIMAL + solution_qc=PASS`, Base flexibility is disabled, security is 5%/3.5 s, 337 center rows and all 59 manifest entries are present, and maximum center/province/intra-capacity residuals are `3.01e-12/4.55e-13/4.61e-10 GWh`. BECCS net-carbon closure is zero. A new 168h Base chain is active under PID `3321747` at `/data/zz2/National_model/outputs/planning_sequence_168h_v0722_city337`; do not change server checkout while it runs.
