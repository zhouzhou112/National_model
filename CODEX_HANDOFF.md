...
- The independent 24h V2G root `/data/zz2/National_model/outputs/planning_sequence_24h_v0722_city337_flexible_load_v2g_v1` also passes four years, manifests and immediate `--resume`; runtimes are 44.81/43.45/48.35/45.23 s, wall 9:10, peak RSS 934,340 KiB and zero swaps. Maximum V2G transition residual is `1.83e-12 GWh`, simultaneous charge/discharge is zero and `charge-discharge` matches the reported net-load energy change. PID `4032297` now runs the corresponding independent 168h V2G chain; keep checkout `cf39e0a` and data immutable while it runs.
