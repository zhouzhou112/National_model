...
- Handoff version: `v0.9.6`
- Snapshot date: `2026-07-22`
- Local repository: `D:\codeenv\pycharmproject\National_RL\National_model`
- Git branch: `codex/cispo-2030-full-lp`
- Local Git HEAD is `8e76753` (`feat: promote 337-city load-center network`). It includes the reviewed reliability update (provincial capacity margin `5%`; inertia `3.5 s reference × 1.0 tolerance`) and promotes the fully rebuilt `city_337` load-center package to the production configuration. The fixed-server checkout was reverified clean and idle at `6ed943a` before deployment; no accepted server output has been modified.
