...
5. `config/optimization_2030.json` 与 `config/scenarios/`：Base、V1、V2G 情景开关；
...
截至 2026-07-23，固定服务器 `city_337` Base、`flexible_load_v1` 与独立 `flexible_load_v2g_v1` 的四年份 24h/168h 工程门禁均已通过。它们是求解/接口验证，不是 8760h 科学规划结果。
