...
## 2026-07-26 five-profile 168h comparison closed; one 744h Barrier gate active
...
- One fixed-server 744h Base gate is active at `/data/zz2/National_model/outputs/2030_744h_v0726_spill_explicit_barrier16_auto_order`. It was launched from clean HEAD `c879c99` with about 69 GiB available RAM, `barrier_16_auto_order_v1`, `Threads=16`, `Crossover=1` and `SoftMemLimit=48`; Python PID at launch was `663050`. No second solve may be started. Acceptance requires `OPTIMAL`, `solution_qc=PASS` and a closed result manifest.
- The active 744h build gate passed in 341.673 s: 3,686,023 variables, 5,920,701 constraints, 42,360,391 nonzeros and 4.977 GiB build peak RSS. Presolve took 223.80 s and reduced the matrix to 3,088,821 rows, 3,017,979 columns and 30,884,732 nonzeros. Ordering took 115.48 s; `AA' NZ=6.449e7`, `Factor NZ=8.062e8` (about 9.0 GB) and `Factor Ops=6.197e12`. Barrier iteration 4 completed at solver time 492.91 s; telemetry peak solver memory was 25.087 GB, observed process RSS about 19.1 GiB and host available memory about 50 GiB. The run remains healthy but unaccepted.
- Barrier has now completed normally in 244 iterations and 8,917.48 solver seconds with interior objective `2,196,881.94 million CNY`; crossover is active. Dual pushes fell from 1,044,784 to 464,775 remaining, and telemetry reached 358,606 simplex iterations at 9,996.25 s. Current solver memory is 13.948 GB, peak solver memory remains 25.087 GB, process RSS is about 13.8 GiB and host available memory about 55 GiB. No solve/QC/manifest exists yet; do not accept or start another solve.
