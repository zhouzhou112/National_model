...
- 2026-07-29 13:43:13+08:00 live snapshot：wrapper/Python PID `1004972/1004975`，elapsed `56:13`；Barrier iteration `87`、runtime `2994.35 s`、primal/dual infeasibility `0.012933/0.004586`、complementarity `3.36656`，solver current/max memory `13.56/23.13 GiB`。主机约 `95 GiB` available、swap `781 MiB/2.0 GiB`；三次 `vmstat` 无新增 swap-in/out，memory PSI avg10/60/300 均为 0。`solve_report.json`、`solution_qc.json`、`result_manifest.json` 尚不存在。
